    ...
    var body: some View {
        ZStack {
            VStack {
                ...
                BriefSquareView(heightRatio: heightRatio,
                                widthRatio: widthRatio,
                                selectedTemplate: viewModel.selectedTemplate,
                                onPressUseTemplate: {
                    viewModel.templateEditName = viewModel.selectedTemplate?.templateName ?? ""
                    viewModel.isImageInputModalPresented.toggle()
                }, isImageInputModalPresented: $viewModel.isImageInputModalPresented
                )
                ScrollView {
                    LazyVGrid(
