        ...
        GeometryReader { geometry in
            ZStack {
                VStack {
                    ...
                    BriefSquareView(heightRatio: 1.0, widthRatio: 1.0, isImageInputModalPresented: $isImageInputModalPresented, isPagePreviewModalPresented: $isPagePreviewModalPresented ) // Use fixed values
